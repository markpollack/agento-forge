...
3. **Cross-corpus search** — Should multiple projects share a corpus, or should each Forge project have its own? A shared corpus amortizes indexing cost but creates relevance noise.
