...
Software Architectures* (ATAM) · Jacobson — use-case-driven design. Empirical corpus: `agent-workflow/
plans/v3/` (reviews 1–2, contract rounds 1–5, `research/gap-hunt-iac-family.md`, the 0.2/0.2c spikes,
`journal/`, `inbox/gap-hunt-disposition-2026-07-23.md` Bucket D).
